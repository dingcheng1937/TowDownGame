...
func _shootAnim():
	...
	gun_tween.tween_property(self, "position", position, 0.15).from(position + Vector2(-1, -1))
	gun_tween.tween_property($Sprite2D, "scale", Vector2(1,1), 0.15).from(Vector2(0.5, 1.1))
